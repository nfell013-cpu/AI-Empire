  ...
  try {
    ...
    await prisma.tokenTransaction.create({
      data: {
        ...
        type: "usage",
        description: "StockSense analysis",
        toolSlug: "stocksense",
      },
    });
    ...
    const response = await fetch("https://api.openai.com/v1/chat/completions", {
      ...
      body: JSON.stringify({
        ...
        messages: [
          {
            role: "system",
            content: `You are StockSense, an AI market analysis tool. Provide investment insights (not financial advice). Return JSON with: analysis, sentiment, riskLevel, technicalIndicators[{name, value, signal}], fundamentals{pe, marketCap, revenue}, newsImpact[], sectorTrends[], peerComparison[], disclaimer.`
          },
          {
            role: "user",
            content: input,
