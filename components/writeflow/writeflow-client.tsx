...
import { BookOpen, Loader2, Copy, CheckCircle, Zap, AlertCircle } from "lucide-react";

export default function WriteFlowClient() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const res = await fetch("/api/writeflow/analyze", {
        method: "POST",
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 space-y-6">
      ...
      >
        ...
        <div>
          <h1 className="text-2xl font-bold" style={{ color: "var(--text-primary)" }}>WriteFlow</h1>
          <p className="text-sm" style={{ color: "var(--text-secondary)" }}>AI long-form content writer & blog generator</p>
        </div>
      </motion.div>
      ...
      >
        ...
        <textarea
          ...
          placeholder="Describe what you want to write: blog post, article, story, etc..."
