...
import { FileBarChart, Loader2, Copy, CheckCircle, Zap, AlertCircle } from "lucide-react";
...
export default function PitchDeckClient() {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 space-y-6">
      ...
      >
        <div className="p-3 rounded-2xl" style={{ background: "#0ea5e920" }}>
          <FileBarChart className="w-8 h-8" style={{ color: "#0ea5e9" }} />
        </div>
        <div>
          <h1 className="text-2xl font-bold" style={{ color: "var(--text-primary)" }}>PitchDeck</h1>
          <p className="text-sm" style={{ color: "var(--text-secondary)" }}>AI startup pitch deck & investor brief builder</p>
        </div>
      </motion.div>
      ...
      >
        ...
        <textarea
          ...
          placeholder="Describe your business idea, market, and funding goals..."
        ...
        >
          {loading ? (
            ...
            <><Zap className="w-4 h-4" /> Generate Pitch Deck</>
          )}
        </button>
      </motion.div>
