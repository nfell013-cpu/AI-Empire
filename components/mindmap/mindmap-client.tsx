...
export default function MindMapClient() {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 space-y-6">
      ...
      >
        <div className="p-3 rounded-2xl" style={{ background: "#c026d320" }}>
          <Cpu className="w-8 h-8" style={{ color: "#c026d3" }} />
        </div>
        <div>
          <h1 className="text-2xl font-bold" style={{ color: "var(--text-primary)" }}>MindMap</h1>
          <p className="text-sm" style={{ color: "var(--text-secondary)" }}>AI brainstorming & mind map visualization tool</p>
        </div>
      </motion.div>
      ...
      >
        ...
        <textarea
          ...
          placeholder="Enter a topic or concept to create a mind map for..."
        ...
        >
          {loading ? (
            ...
            <><Zap className="w-4 h-4" /> Generate Mind Map</>
          )}
        </button>
      </motion.div>
